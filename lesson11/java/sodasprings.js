...
function toggleMenu() {
  ...
  //summary
const apiURL = "api.openweathermap.org/data/2.5/forecast?q=sodasprings&appid=5607916";
...
fetch(apiURL)
 ...
 .then((town) => {
  ...
  //forecast
  const apiURL_forecast = "api.openweathermap.org/data/2.5/forecast?q=sodasprings&appid=5607916"
